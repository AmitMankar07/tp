...
console.log(`StaffID${staffId},SelectedService${selectedServices}`)
    // Validate input
    ...
    try {
        ...
        console.log("Sending payload:", { staffId, serviceIds: selectedServices });
...
function loadAssignments() {
    ...
    .then(response => {
        ...
        response.data.forEach(assignment => {
            ...
            // Safely access services and join names
            const servicesList = assignment.services?.map(service => service.name).join(', ') || 'No services assigned';

            assignmentElement.innerHTML = `
                <p><strong>Staff:</strong> ${assignment.staffName}</p>
                <p><strong>Assigned Services:</strong> ${servicesList}</p>
            `;
    ...
    console.log("GET API call complete.");
}
